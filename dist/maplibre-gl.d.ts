...
export declare class Evented {
	...
	fire(event: Event, properties?: any): this;
	/**
...
export declare class TerrainSourceCache extends Evented {
	 ...
	 */
	enable(sourceCache: SourceCache, options?: {
		exaggeration: number;
		elevationOffset: number;
	}): void;
	/**
	 ...
	 * @returns {number}
	 */
	getElevationWithExaggeration(tileID: OverscaledTileID, x: number, y: number, extent?: number): number;
	/**
...
export declare class Transform {
	 ...
	 * @private
	 */
	coordinatePoint(coord: MercatorCoordinate, elevation?: number): Point;
	/**
...
export declare class Program<Us extends UniformBindings> {
	...
	}, configuration: ProgramConfiguration, fixedUniforms: (b: Context, a: UniformLocations) => Us, showOverdrawInspector: boolean, useTerrain: boolean);
	draw(context: Context, drawMode: DrawMode, depthMode: Readonly<DepthMode>, stencilMode: Readonly<StencilMode>, colorMode: Readonly<ColorMode>, cullFaceMode: Readonly<CullFaceMode>, uniformValues: UniformValues<Us>, terrain: any, layerID: string, layoutVertexBuffer: VertexBuffer, indexBuffer: IndexBuffer, segments: SegmentVector, currentProperties?: any, zoom?: number | null, configuration?: ProgramConfiguration | null, dynamicLayoutBuffer?: VertexBuffer | null, dynamicLayoutBuffer2?: VertexBuffer | null, dynamicLayoutBuffer3?: VertexBuffer | null): void;
}
...
export declare class Placement {
	...
	attemptAnchorPlacement(anchor: TextAnchor, textBox: SingleCollisionBox, width: number, height: number, textBoxScale: number, rotateWithMap: boolean, pitchWithMap: boolean, textPixelRatio: number, posMatrix: mat4, collisionGroup: CollisionGroup, textOverlapMode: OverlapMode, symbolInstance: SymbolInstance, bucket: SymbolBucket, orientation: number, iconBox?: SingleCollisionBox | null, getElevation?: any): {
		shift: Point;
		placedGlyphBoxes: {
			box: Array<number>;
			offscreen: boolean;
...
export declare type TerrainOptions = {
	id?: string;
	options?: {
		exaggeration: number;
		elevationOffset: number;
